  ...
  .then((data) => {
    data.slice(0, 3)/*muestra 3 primeros resultados del array data*/.forEach((comment) => {
      ...
      const buttons = document.createRange().createContextualFragment(` 
                  ...
                  <!-- Boton Like -->
                  <button class="btn btn-outline-danger border-0 rounded-circle " id="boton_likes" type="submit" >
                  ...
                  <p id="total_likes" class="ms-1 mt-2"> Total de likes id publicación</p>
                  </div>
